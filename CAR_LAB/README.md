...
普通用户无需从本目录运行源码。请从 [GitHub Releases](https://github.com/zhaoxc857/DiCar_Tune/releases) 下载 `DiCAR-LAB-v1.7.0-Windows-x64.zip`，完整解压后运行 `DiCAR LAB.exe`。发布包通过根目录的 `build_portable_windows.bat` 生成。
