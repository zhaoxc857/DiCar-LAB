...
class ReleaseDocumentationTests(unittest.TestCase):
    def test_readme_names_download_and_documents_wireless_flashing(self):
        ...
        self.assertIn("DiCAR-LAB-v1.8.1-Windows-x64.zip", readme)
        self.assertIn("DiCAR-LAB-v1.8.1-Windows-x64-onefile.exe", readme)
    ...
    def test_changelog_starts_with_v181_release(self):
        ...
        self.assertLess(changelog.index("## v1.8.1"), changelog.index("## v1.8.0"))
